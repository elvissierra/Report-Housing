...
def test_correlation_with_grouping(sample_df):
    ...
    # Test Group 'A'
    group_a_corr = results_df.loc[results_df['Group'] == 'A', 'Correlation Value'].iloc[0]
    ...
    # Test Group 'B'
    group_b_corr = results_df.loc[results_df['Group'] == 'B', 'Correlation Value'].iloc[0]
